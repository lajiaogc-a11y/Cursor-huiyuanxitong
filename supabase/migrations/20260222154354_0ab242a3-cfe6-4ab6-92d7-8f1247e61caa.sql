...
-- Dashboard trend data aggregation RPC
-- Returns daily order count and profit for a given date range
...
BEGIN
  ...
  SELECT
    ...
    -- Approximate: sum of unique phones from both (may overcount slightly)
