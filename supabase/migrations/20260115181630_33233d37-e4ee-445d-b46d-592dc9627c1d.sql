-- Fix redeem_points_and_record: use ledger-based balance instead of points_accounts.current_points
-- This prevents false NO_POINTS when points_accounts row is missing/out of sync.
...
BEGIN
  ...
  SELECT COALESCE(public.calculate_member_points(p_member_code, v_last_reset_time::text), 0)
