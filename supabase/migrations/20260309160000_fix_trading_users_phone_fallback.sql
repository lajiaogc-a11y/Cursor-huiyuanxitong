-- 修复仪表盘交易用户为 0
-- 1. base_filter 增加 members 关联：当 orders.phone_number 为空时，用 members.phone_number
-- 2. 确保 sales_user_id 为 NULL 时用 creator 判断租户/销售员（已在 run-fixes 中）
...
-- platform_get_dashboard_trend_data（平台查看租户）
