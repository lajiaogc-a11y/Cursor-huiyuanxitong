...
const BACKUP_TABLES = [
  // Tier 1 - Core Business (high-value, hard to recreate)
  "orders", "members", "ledger_transactions",
  "points_ledger", "points_accounts",
  // Tier 2 - Employee & Access Control
  "employees", "employee_permissions", "role_permissions",
  // Tier 3 - Business Configuration (small tables, rarely changes)
  "vendors", "cards", "card_types", "payment_providers",
  "shared_data_store", "referral_relations",
];
