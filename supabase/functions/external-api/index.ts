...
// 检查权限（与前台 API 管理中的权限值一致；含细粒度 activity_* / order_*）
function hasPermission(permissions: string[], endpoint: string): boolean {
  ...
  const endpointMap: Record<string, string[]> = {
    ...
    '/activity': ['activity_data', 'activity', 'activity_summary'],
    '/activity/summary': ['activity_data', 'activity', 'activity_summary'],
    '/activity/list': ['activity_data', 'activity', 'activity_list'],
    '/activity/gifts': ['activity_data', 'activity', 'gift_records'],
    '/activity/points': ['activity_data', 'activity', 'points_ledger', 'points'],

    '/orders': ['orders', 'order_management', 'order_list'],
    '/orders/list': ['orders', 'order_management', 'order_list'],
    '/orders/detail': ['orders', 'order_management', 'order_detail'],
    '/orders/stats': ['orders', 'order_management', 'order_stats'],
