...
export async function triggerWebhookEvent(
  ...
  try {
    ...
    console.log(`[WebhookService] Triggering event: ${eventType}`, payload);
    ...
    if (error) {
      console.error('[WebhookService] Failed to trigger event:', error);
      return false;
    }

    console.log(`[WebhookService] Event queued successfully:`, data);
    return true;
  } catch (error) {
