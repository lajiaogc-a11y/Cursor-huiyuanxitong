...
export function useShiftHandoverFormPersistence() {
    ...
    const loadFromDb = async () => {
      try {
        ...
        if (isMountedRef.current && saved) {
          ...
          console.log('[ShiftHandoverFormPersistence] Loaded user data:', mergedData);
        }
  ...
  const saveToDb = useCallback((data: ShiftHandoverFormData) => {
    ...
    saveTimeoutRef.current = setTimeout(async () => {
      ...
      try {
        ...
        console.log('[ShiftHandoverFormPersistence] Saved user data');
      } catch (error) {
  ...
  const clearForm = useCallback(async () => {
    ...
    console.log('[ShiftHandoverFormPersistence] Form cleared');
  }, []);
