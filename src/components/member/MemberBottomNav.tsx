...
const navItems = [
  ...
  { path: ROUTES.MEMBER.POINTS, icon: Gift, zh: "商店", en: "Shop" },
  { path: ROUTES.MEMBER.SPIN, icon: Star, zh: "转盘", en: "Spin" },
  { path: ROUTES.MEMBER.INVITE, icon: Users, zh: "推荐", en: "Refer" },
  { path: ROUTES.MEMBER.SETTINGS, icon: Settings, zh: "我的", en: "Me" },
] as const;
