...
import { useNotifications, type Notification } from '@/hooks/system/useNotifications';
...
export function NotificationCenter() {
  ...
  return (
    ...
    <AlertDialog open={confirmDeleteId !== null} onOpenChange={(o) => !o && setConfirmDeleteId(null)}>
      <AlertDialogContent>
        <AlertDialogHeader>
          <AlertDialogTitle>{t('删除这条通知？', 'Delete this notification?')}</AlertDialogTitle>
          <AlertDialogDescription>
            {t('将从列表中移除，无法恢复。', 'It will be removed from the list. This cannot be undone.')}
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
