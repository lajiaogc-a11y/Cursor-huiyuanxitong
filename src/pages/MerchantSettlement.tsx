...
export default function MerchantSettlement() {
  ...
  return (
    <div className="space-y-4">
      ...
      <CardMerchantDialogs
        isInitialBalanceDialogOpen={isInitialBalanceDialogOpen}
        setIsInitialBalanceDialogOpen={setIsInitialBalanceDialogOpen}
        currentVendor={currentVendor}
        initialBalanceAmount={initialBalanceAmount}
        setInitialBalanceAmount={setInitialBalanceAmount}
        currentVendorData={currentVendorData}
        onSaveInitialBalance={handleSaveInitialBalance}
        isWithdrawalDialogOpen={isWithdrawalDialogOpen}
        setIsWithdrawalDialogOpen={setIsWithdrawalDialogOpen}
        withdrawalAmountUsdt={withdrawalAmountUsdt}
        setWithdrawalAmountUsdt={setWithdrawalAmountUsdt}
        withdrawalUsdtRate={withdrawalUsdtRate}
        setWithdrawalUsdtRate={setWithdrawalUsdtRate}
        withdrawalRemark={withdrawalRemark}
        setWithdrawalRemark={setWithdrawalRemark}
        ...
        canEditBalance={canEditBalance}
        withdrawalSelectionState={withdrawalSelectionState}
        ...
        onConfirmDeleteWithdrawal={handleConfirmDeleteWithdrawal}
        pendingBatchWithdrawalDelete={pendingBatchWithdrawalDelete}
        setPendingBatchWithdrawalDelete={setPendingBatchWithdrawalDelete}
        onConfirmBatchDeleteWithdrawals={handleConfirmBatchDeleteWithdrawals}
        isUndoConfirmOpen={isUndoConfirmOpen}
        setIsUndoConfirmOpen={setIsUndoConfirmOpen}
        undoDescription={undoDescription}
        undoPassword={undoPassword}
        setUndoPassword={setUndoPassword}
        undoAuthError={undoAuthError}
        setUndoAuthError={setUndoAuthError}
        isUndoVerifying={isUndoVerifying}
        resetUndoAuthState={resetUndoAuthState}
      ...
      <PaymentProviderDialogs
        isProviderInitialBalanceDialogOpen={isProviderInitialBalanceDialogOpen}
        setIsProviderInitialBalanceDialogOpen={setIsProviderInitialBalanceDialogOpen}
        currentProvider={currentProvider}
        providerInitialBalanceAmount={providerInitialBalanceAmount}
        setProviderInitialBalanceAmount={setProviderInitialBalanceAmount}
        currentProviderData={currentProviderData}
        onSaveProviderInitialBalance={handleSaveProviderInitialBalance}
        isRechargeDialogOpen={isRechargeDialogOpen}
        setIsRechargeDialogOpen={setIsRechargeDialogOpen}
        rechargeAmountUsdt={rechargeAmountUsdt}
        setRechargeAmountUsdt={setRechargeAmountUsdt}
        rechargeUsdtRate={rechargeUsdtRate}
        setRechargeUsdtRate={setRechargeUsdtRate}
        rechargeRemark={rechargeRemark}
        setRechargeRemark={setRechargeRemark}
        rechargeSettlementTotal={rechargeSettlementTotal}
        onSaveRecharge={handleSaveRecharge}
        isProviderDetailsDialogOpen={isProviderDetailsDialogOpen}
        setIsProviderDetailsDialogOpen={setIsProviderDetailsDialogOpen}
        currentRecharges={currentRecharges}
        canEditBalance={canEditBalance}
        onEditRecharge={handleEditRecharge}
        setDeletingRechargeId={setDeletingRechargeId}
        editingRecharge={editingRecharge}
        setEditingRecharge={setEditingRecharge}
        onSaveEditRecharge={handleSaveEditRecharge}
        deletingRechargeId={deletingRechargeId}
        onConfirmDeleteRecharge={handleConfirmDeleteRecharge}
        isProviderUndoConfirmOpen={isProviderUndoConfirmOpen}
        setIsProviderUndoConfirmOpen={setIsProviderUndoConfirmOpen}
        providerUndoDescription={providerUndoDescription}
        undoPassword={undoPassword}
        setUndoPassword={setUndoPassword}
        undoAuthError={undoAuthError}
        setUndoAuthError={setUndoAuthError}
        ...
        resetUndoAuthState={resetUndoAuthState}
        employeeUsername={employee?.username || ""}
        onConfirmProviderUndo={handleConfirmProviderUndo}
        isSaving={isSaving}
      />
