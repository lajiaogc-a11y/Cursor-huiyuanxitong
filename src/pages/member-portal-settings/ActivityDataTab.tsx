...
type ActivityDataSubKey = "checkin" | "spin_order" | "spin_share" | "spin_invite";
...
export function ActivityDataTab({ tenantId }: ActivityDataTabProps) {
  ...
  const [activityDataSub, setActivityDataSub] = useState<ActivityDataSubKey>("checkin");
  ...
  useEffect(() => {
    if (activityDataSub === "checkin") void loadCheckInsPage(1, filters.checkin);
