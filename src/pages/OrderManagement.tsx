...
import {
  ...
  computeUsdtOrderFieldChanges,
  getCurrencyOptions,
  getNormalOrderColumns,
  getOrderStatusOptions,
  getUsdtOrderColumns,
  resolveOrderSalesEmployeeId,
} from "@/pages/orders/orderColumnConfig";
import { OrderBatchConfirmDialog } from "@/pages/orders/OrderBatchConfirmDialog";
  ...
  return (
    <div className="space-y-6">
      ...
      <OrderBatchConfirmDialog
        open={orderBatchDialog !== null}
        dialog={orderBatchDialog}
        onOpenChange={(open) => !open && setOrderBatchDialog(null)}
        t={t}
        selectedNormalDbIds={selectedNormalDbIds}
        selectedUsdtDbIds={selectedUsdtDbIds}
        selectedMeikaFiatDbIds={selectedMeikaFiatDbIds}
        selectedMeikaUsdtDbIds={selectedMeikaUsdtDbIds}
        normalBatchCancelCount={normalBatchCancelCount}
        usdtBatchCancelCount={usdtBatchCancelCount}
        meikaFiatBatchCancelCount={meikaFiatBatchCancelCount}
        meikaUsdtBatchCancelCount={meikaUsdtBatchCancelCount}
        onConfirm={confirmOrderBatchAction}
      />
    </div>
  );
}
