...
/**
 * 执行迁移：会员系统高级活动配置
 * 文件：20260403000003_member_portal_activity_advanced.sql
 */
import pg from "pg";
...
`);
  ...
  const migrationFile = "20260403000003_member_portal_activity_advanced.sql";
  ...
  try {
    ...
    console.log("✓ 已启用会员系统高级配置（活动奖励参数/邀请码页面品牌化/后端开关生效）");
  } catch (err) {
